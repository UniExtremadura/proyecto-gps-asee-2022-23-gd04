...
class LoginTest {
    ...
    fun loginTest() {
        ...
        val textView = onView(
            allOf(
                withId(R.id.nombre_value), withText("josefino"),
                withParent(withParent(withId(android.R.id.content))),
                isDisplayed()
            )
        )
        textView.check(matches(withText("josefino")))
        Thread.sleep(500)

        val textView2 = onView(
            allOf(
                withId(R.id.usuario_value), withText("josejose"),
                withParent(withParent(withId(android.R.id.content))),
                isDisplayed()
            )
        )
        textView2.check(matches(withText("josejose")))
        Thread.sleep(500)

        val textView3 = onView(
            allOf(
                withId(R.id.email_value), withText("josejose@gmail.com"),
                withParent(withParent(withId(android.R.id.content))),
                isDisplayed()
            )
        )
        textView3.check(matches(withText("josejose@gmail.com")))
        Thread.sleep(500)
