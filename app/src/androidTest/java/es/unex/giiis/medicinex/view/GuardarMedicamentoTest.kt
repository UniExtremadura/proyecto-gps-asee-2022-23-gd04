...
class GuardarMedicamentoTest {
    ...
    fun guardarMedicamentoTest() {
        ...
        val appCompatImageView3 = onView(
            allOf(
                withId(R.id.addToFAK), withContentDescription("Añade al medicamento al botiquín."),
                childAtPosition(
                    childAtPosition(
                        withClassName(`is`("android.widget.FrameLayout")),
                        0
        ...
        val bottomNavigationItemView = onView(
            allOf(
                withId(R.id.first_aid_kit), withContentDescription("Botiquín"),
                childAtPosition(
                    childAtPosition(
        ...
        val textView = onView(
            allOf(
                withId(R.id.medicamento), withText("<CHICLE MEDICAMENTOSOS 25 mg ASUCAR"),
                withParent(withParent(withId(R.id.fak_RV))),
                isDisplayed()
            )
        )
        ...
        val bottomNavigationItemView2 = onView(
            allOf(
                withId(R.id.init), withContentDescription("Inicio"),
                childAtPosition(
                    childAtPosition(
                        withId(R.id.bottomNavView),
                        0
