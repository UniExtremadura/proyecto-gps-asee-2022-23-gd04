...
class FilteredSearchTest {
    ...
    object CustomRecyclerViewAssertions {
        //Asserts the number of items in a RecyclerView
        fun AssertItemCount(expectedCount: Int): ViewAssertion
        {
            return ViewAssertion { view, noViewFoundException ->
                ...
                assert(adapter!!.itemCount == expectedCount || adapter!!.itemCount == expectedCount * 2)
            }
        }
    }

    @Test
    fun filteredSearchTest() {
        ...
        val checkBox = onView(
            allOf(
                withId(R.id.checkBoxReceipt), withText("Mostrar solo si no necesita receta"),
        ...
        onView(withId(R.id.medicine_rv)).check(CustomRecyclerViewAssertions.AssertItemCount(1))
